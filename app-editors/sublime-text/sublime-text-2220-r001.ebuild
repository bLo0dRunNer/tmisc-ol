...
#        doins "${FILESDIR}"/${PN}.desktop
	...
	make_desktop_entry "subl" "Sublime Text Editor" /opt/${PN}/${PN}-icon-128.png "Applications;Development"
}
