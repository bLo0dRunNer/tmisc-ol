...
# teamviewer_desktop no existe
# creo que lo ha sustituido TeamViewer_Desktop
#               doexe script/teamviewer{,_desktop} script/tvw_{aux,config,exec,extra,main,profile}
                doexe script/teamviewer TeamViewer_Desktop script/tvw_{aux,config,exec,extra,main,profile}
